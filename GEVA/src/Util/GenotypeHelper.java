...
//        System.out.format("c1: %d; c2: %d; c: %d, %d;%n", c1.allocationSize(), c2.allocationSize(), c.allocationSize(), c.size());
	...
	if(mutatePoint == 0){
	    System.arraycopy(giverArr, 0,
			     newArr, 0,
			     giverUsedCodons);
	    System.arraycopy(receiverArr, 0,
			     newArr, giverUsedCodons,
			     receiverUsedCodons);
	}
	else{
	    System.arraycopy(receiverArr, 0,
	    ...
	    System.arraycopy(giverArr, 0,
			     newArr, mutatePoint,
			     giverUsedCodons);
	    System.arraycopy(receiverArr, mutatePoint,
			     newArr, (mutatePoint + giverUsedCodons),
